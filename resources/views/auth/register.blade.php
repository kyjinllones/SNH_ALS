                ...
                <div><h1>{{ __('Register') }}</h1></div>
                   ...
                   <form method="POST" action="{{ route('register') }}">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <input placeholder="User Name" id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" required autofocus>
